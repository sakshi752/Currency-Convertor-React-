      ...
      <div className='w-full max-w-lg mx-auto border border-gray-400 p-5 rounded bg-white/30 backdrop-blur-2xl'>
        ...
        >
          ...
          <div className="relative w-full h-0.5">
            <button  type="button" className='absolute left-1/2 -translate-x-1/2 -translate-y-1/2 px-2 py-0.5 bg-blue-600 text-white rounded-md cursor-pointer' onClick={swap}>Swap</button>
          </div>
          <div className='my-1'>
